 ...
 *
 *=========================================================================*/
#ifndef __itkGPUMyMeanImageFilter_hxx
#define __itkGPUMyMeanImageFilter_hxx

#include "itkGPUMyMeanImageFilter.h"

namespace itk
{

template< typename TInputImage, typename TOutputImage >
GPUMyMeanImageFilter< TInputImage, TOutputImage >::GPUMyMeanImageFilter()
{
  ...
  if(TInputImage::ImageDimension > 3)
    {
    itkExceptionMacro("GPUMyMeanImageFilter supports 1/2/3D image.");
    }
  ...
  //const char* GPUSource = GPUMyMeanImageFilter::GetOpenCLSource();

  // load and build program
  //this->m_GPUKernelManager->LoadProgramFromString( GPUSource, defines.str().c_str() );
  this->m_GPUKernelManager->LoadProgramFromFile("/home/alexandrefreitas/Projetos/ITKProjects/itkGPUMeanImageFilterTest/src/GPUMeanImageFilter.cl", defines.str().c_str() );
...
GPUMyMeanImageFilter< TInputImage, TOutputImage >::~GPUMyMeanImageFilter()
{
  std::cout<<"~GPUMyMeanImageFilter()"<<std::endl;
}

template< typename TInputImage, typename TOutputImage >
void GPUMyMeanImageFilter< TInputImage, TOutputImage >::PrintSelf(std::ostream & os, Indent indent) const
{
...
template< typename TInputImage, typename TOutputImage >
void GPUMyMeanImageFilter< TInputImage, TOutputImage >::GPUGenerateData()
{

  std::cout<<"GPUGenerateData()"<<std::endl;
