 ...
 * (Altered by: Francisco Xavier, 3 February 2014)
 */
...
static void PrintPlatform(cl_platform_id platform, int count) 
{
...
main(int argc, char * argv[])
{
    ...
    for (ii = 0; ii < (int) numPlatforms; ii++) {
       PrintPlatform(platformList[ii], ii);
    }
