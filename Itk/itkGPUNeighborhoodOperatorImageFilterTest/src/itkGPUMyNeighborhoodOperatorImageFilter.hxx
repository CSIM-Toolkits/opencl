 ...
 *
 *=========================================================================*/
#ifndef __itkGPUMyNeighborhoodOperatorImageFilter_hxx
#define __itkGPUMyNeighborhoodOperatorImageFilter_hxx
...
void
GPUMyNeighborhoodOperatorImageFilter< TInputImage, TOutputImage, TOperatorValueType >
...
GPUMyNeighborhoodOperatorImageFilter< TInputImage, TOutputImage, TOperatorValueType, TParentImageFilter >
::GPUMyNeighborhoodOperatorImageFilter()
{
  ...
  if(TInputImage::ImageDimension > 3 || TInputImage::ImageDimension < 1)
    {
    itkExceptionMacro("GPUMyNeighborhoodOperatorImageFilter supports 1/2/3D image.");
    }
  ...
  //const char* GPUSource = GPUMyNeighborhoodOperatorImageFilter::GetOpenCLSource();
  // load and build program
  //this->m_GPUKernelManager->LoadProgramFromString( GPUSource, defines.str().c_str() );

  this->m_GPUKernelManager->LoadProgramFromFile("/home/alexandrefreitas/Projetos/ITKProjects/itkGPUNeighborhoodOperatorImageFilterTest/src/GPUNeighborhoodOperatorImageFilter.cl", defines.str().c_str() );
