...
#include <Configure.h>
        ...
        cl::Image3D inputImage2D;                       /**< CL Input image2d */
        cl::Image3D outputImage2D;                      /**< CL Output image2d */
...
*/
    ...
    inputImage2D = cl::Image3D(context,
                               CL_MEM_READ_ONLY,
    ...
    outputImage2D = cl::Image3D(context,
                                CL_MEM_WRITE_ONLY,
                                cl::ImageFormat(CL_RGBA, CL_UNSIGNED_INT8),
                                width,
                                height,
