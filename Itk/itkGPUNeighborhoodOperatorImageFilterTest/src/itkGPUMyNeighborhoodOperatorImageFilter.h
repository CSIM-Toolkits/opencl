 ...
 *
 *=========================================================================*/
#ifndef __itkGPUMyNeighborhoodOperatorImageFilter_h
#define __itkGPUMyNeighborhoodOperatorImageFilter_h
...
namespace itk
{
/** \class GPUMyNeighborhoodOperatorImageFilter
...
/** Create a helper GPU Kernel class for GPUMyNeighborhoodOperatorImageFilter */
itkGPUKernelClassMacro(GPUMyNeighborhoodOperatorImageFilterKernel);
...
public:
  ...
  typedef GPUMyNeighborhoodOperatorImageFilter                                     Self;
  ...
  itkTypeMacro(GPUMyNeighborhoodOperatorImageFilter, GPUImageToImageFilter);
  ...
  //itkGetOpenCLSourceFromKernelMacro(GPUMyNeighborhoodOperatorImageFilterKernel);
...
protected:
  GPUMyNeighborhoodOperatorImageFilter();
  virtual ~GPUMyNeighborhoodOperatorImageFilter() {
  }
...
private:
  GPUMyNeighborhoodOperatorImageFilter(const Self &); //purposely not implemented
...
#include "itkGPUMyNeighborhoodOperatorImageFilter.hxx"
#endif
